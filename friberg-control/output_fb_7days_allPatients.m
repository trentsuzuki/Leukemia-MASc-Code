...
% patients using a 7-day hold output feedback control method. It reads 
...
subplot(2,1,1);
hold on;
title(['7-Day Hold Output Feedback Control: All Patients (', ...
...
for p_idx = 1:height(patientData) 
    ...
    for i = 1:num_simulations
        ...
        % Define the control law. It takes a state vector as input, but uses only the 5th state.
...
if save_trajectory_figure
    ...
    trajectory_filename = 'figs/7Day_Hold_Output_fb_All_Patients.png';
